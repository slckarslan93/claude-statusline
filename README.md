...
```
📁 my-app  ·  ⎇ main  ·  🤖 Opus 4.8  ·  ⚡ max  ·  🧠  ·  [▓▓░░░░░░░░] 18% 185k/1M  ·  ♻ cache 100%  ·  💰 $0.42  ·  +156/-23  ·  ⏱ 12m  ·  5h:2% 3h 7m  ·  7d:61% 52h 37m
```
...
- **Respects `NO_COLOR`** and degrades to plain text with `icons: false`.
...
| `icons` | `true` | Emoji glyphs; `false` → short text labels |
...
| `thinking` | 🧠 when extended thinking is on | `thinking.enabled` |
